                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                        <select name="MOLLIE_BANCONTACT_QR_CODE_ENABLED" class="fixed-width-xl"
                          ...
                          <option
                            value="0" {if $input.isBancontactQrCodeEnabled == 0} selected {/if}>{l s='No' mod='mollie'}</option>
                          <option
                            value="1" {if $input.isBancontactQrCodeEnabled == 1} selected {/if}>{l s='Yes' mod='mollie'}</option>
                        </select>
                        <p class="help-block">
                  ...
                  <div class="col-lg-9">
                    <select name="MOLLIE_METHOD_API_{$paymentMethod.id|escape:'html':'UTF-8'}"
                        ...
                        {if !in_array($paymentMethod.id, $input.onlyOrderMethods)}
                          <option
                            value="payments" {if $methodObj->method === 'payments'} selected {/if}>{l s='Payments API' mod='mollie'}</option>
                        {/if}
                      <option
                        value="orders" {if $methodObj->method === 'orders'} selected {/if}>{l s='Orders API' mod='mollie'}</option>
                    </select>
                    <p class="help-block">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-9">
                    <select name="MOLLIE_METHOD_APPLICABLE_COUNTRIES_{$paymentMethod.id|escape:'html':'UTF-8'}"
                            class="fixed-width-xl">
                      <option
                        value="0" {if $methodObj->is_countries_applicable == 0} selected {/if}>{l s='All countries' mod='mollie'}</option>
                      <option
                        value="1" {if $methodObj->is_countries_applicable == 1} selected {/if}>{l s='Selected countries' mod='mollie'}</option>
                    </select>
                  </div>
                </div>
                <div class="form-group">

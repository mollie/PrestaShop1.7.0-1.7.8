...
class AdminMollieSettingsController extends ModuleAdminController
{
    ...
    private function displayModuleSettings(): string
    {
        ...
        $html = $templateParser->parseTemplate(
            $this->context->smarty,
            $this->module->getService(LogoInfoBlock::class),
        ...
        $updateMessageInfoBlockData = $updateMessageInfoBlock->setAddons($this->module::ADDONS);
        ...
        $settingsFormBuilder = $this->module->getService(FormBuilder::class);
    ...
    private function setEnvironmentForAccounts()
    {
    ...
    private function setEnvironmentForCloudSync()
    {

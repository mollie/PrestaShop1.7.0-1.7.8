...
class B2bPaymentMethodRestrictionValidatorTest extends BaseTestCase
{
    ...
    public function testItSuccessfullyValidatedIsValid()
    {
        Configuration::set('PS_B2B_ENABLE', 1);

        $molPaymentMethod = new \MolPaymentMethod();
        $molPaymentMethod->id_method = Config::MOLLIE_PAYMENT_METHOD_BILLIE;
    ...
    public function testItSuccessfullyValidatedIsValidMissingVatNumberInFormat()
    {
        Configuration::set('PS_B2B_ENABLE', 1);
    ...
    public function testItUnsuccessfullyValidatedIsValidMethodNotSupported()
    {
        Configuration::set('PS_B2B_ENABLE', 1);
    ...
    public function testItUnsuccessfullyValidatedIsValidMissingSiretNumber()
    {
        Configuration::set('PS_B2B_ENABLE', 1);
    ...
    public function testItUnsuccessfullyValidatedIsValidB2bNotEnabled()
    {
    ...
    public function testItUnsuccessfullyValidatedIsValidMissingVatNumberInBothAddresses()
    {
        Configuration::set('PS_B2B_ENABLE', 1);
    ...
    public function testItUnsuccessfullyValidatedIsValidMissingVatNumberInBillingAddress()
    {
        Configuration::set('PS_B2B_ENABLE', 1);

...
class PaymentFeeProviderTest extends TestCase
{
    ...
    public function testItSuccessfullyProvidesFixedPaymentFee()
    {
    ...
    public function testItSuccessfullyProvidesPercentagePaymentFee()
    {
    ...
    public function testItSuccessfullyProvidesPercentageAndFixedPricePaymentFee()
    {
    ...
    public function testItSuccessfullyProvidesFeeSurchageTypeNotFound()
    {
    ...
    public function testItUnsuccessfullyProvidesFeeAddressNotFound()
    {
        $this->molPaymentMethod->surcharge_percentage = 0;
        $this->molPaymentMethod->surcharge_limit = 0;
        $this->molPaymentMethod->surcharge_fixed_amount_tax_excl = 0;
